...
public class JsonDecoder extends ParsingDecoder implements Parser.ActionHandler {
   ...
   * //From cdpd
   * 
   * private static class JsonElement { public final JsonToken token; public final
   * String value; public JsonElement(JsonToken t, String value) { this.token = t;
   * this.value = value; }
   * 
   * public JsonElement(JsonToken t) { this(t, null); } }
   * 
   * private static List<JsonElement> getVaueAsTree(JsonParser in) throws
   * IOException { int level = 0; List<JsonElement> result = new
   * ArrayList<JsonElement>(); do { JsonToken t = in.getCurrentToken(); switch (t)
   * { case START_OBJECT: case START_ARRAY: level++; result.add(new
   * JsonElement(t)); break; case END_OBJECT: case END_ARRAY: level--;
   * result.add(new JsonElement(t)); break; case FIELD_NAME: case VALUE_STRING:
   * case VALUE_NUMBER_INT: case VALUE_NUMBER_FLOAT: case VALUE_TRUE: case
   * VALUE_FALSE: case VALUE_NULL: result.add(new JsonElement(t, in.getText()));
   * break; } in.nextToken(); } while (level != 0); result.add(new
   * JsonElement(null)); return result; }
   * 
   * private JsonParser makeParser(final List<JsonElement> elements) throws
   * IOException { return new JsonParser() { int pos = 0;
   * 
   * @Override public ObjectCodec getCodec() { throw new
   * UnsupportedOperationException(); }
   * 
   * @Override public void setCodec(ObjectCodec c) { throw new
   * UnsupportedOperationException(); }
   * 
   * @Override public void close() throws IOException { throw new
   * UnsupportedOperationException(); }
   * 
   * @Override public JsonToken nextToken() throws IOException { pos++; return
   * elements.get(pos).token; }
   * 
   * @Override public JsonParser skipChildren() throws IOException { JsonToken tkn
   * = elements.get(pos).token; int level = (tkn == JsonToken.START_ARRAY || tkn
   * == JsonToken.END_ARRAY) ? 1 : 0; while (level > 0) {
   * switch(elements.get(++pos).token) { case START_ARRAY: case START_OBJECT:
   * level++; break; case END_ARRAY: case END_OBJECT: level--; break; } } return
   * this; }
   * 
   * @Override public boolean isClosed() { throw new
   * UnsupportedOperationException(); }
   * 
   * @Override public String getCurrentName() throws IOException { throw new
   * UnsupportedOperationException(); }
   * 
   * @Override public JsonStreamContext getParsingContext() { throw new
   * UnsupportedOperationException(); }
   * 
   * @Override public JsonLocation getTokenLocation() { throw new
   * UnsupportedOperationException(); }
   * 
   * @Override public JsonLocation getCurrentLocation() { throw new
   * UnsupportedOperationException(); }
   * 
   * @Override public String getText() throws IOException { return
   * elements.get(pos).value; }
   * 
   * @Override public char[] getTextCharacters() throws IOException { throw new
   * UnsupportedOperationException(); }
   * 
   * @Override public int getTextLength() throws IOException { throw new
   * UnsupportedOperationException(); }
   * 
   * @Override public int getTextOffset() throws IOException { throw new
   * UnsupportedOperationException(); }
   * 
   * @Override public Number getNumberValue() throws IOException { throw new
   * UnsupportedOperationException(); }
   * 
   * @Override public NumberType getNumberType() throws IOException { throw new
   * UnsupportedOperationException(); }
   * 
   * @Override public int getIntValue() throws IOException { return
   * Integer.parseInt(getText()); }
   * 
   * @Override public long getLongValue() throws IOException { return
   * Long.parseLong(getText()); }
   * 
   * @Override public BigInteger getBigIntegerValue() throws IOException { throw
   * new UnsupportedOperationException(); }
   * 
   * @Override public float getFloatValue() throws IOException { return
   * Float.parseFloat(getText()); }
   * 
   * @Override public double getDoubleValue() throws IOException { return
   * Double.parseDouble(getText()); }
   * 
   * @Override public BigDecimal getDecimalValue() throws IOException { throw new
   * UnsupportedOperationException(); }
   * 
   * @Override public byte[] getBinaryValue(Base64Variant b64variant) throws
   * IOException { throw new UnsupportedOperationException(); }
   * 
   * @Override public JsonToken getCurrentToken() { return
   * elements.get(pos).token; } }; }
   * 
   * 
   * 

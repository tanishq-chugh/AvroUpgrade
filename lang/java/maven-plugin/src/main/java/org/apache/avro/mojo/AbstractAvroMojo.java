...
public abstract class AbstractAvroMojo extends AbstractMojo {
   ...
   *
   * @parameter A list of files or directories that should be compiled first thus
   *            making them importable by subsequently compiled schemas. Note that
   *            imported files should not reference each other.
   * @parameter
   */
